...
describe('Blog tests', () => {
    ...
    beforeEach(() => {
        ...
        const testBlog = (modHandler) => {
            ...
            return (
                <Blog adder={adder} title='Component testing is done with react-testing-library' author='Jollekalle' url='jollensivut.com' likes={3555} id='1' modifyHandler={modifyHandler} removeHandler={removeHandler}/>
            )
        }
